...
- [x] 1.6 Iterate on the demo panorama asset so it contains clear markers/parallax cues while staying under payload limits.
- [x] 1.7 Apply motion smoothing (e.g., exponential moving average) so gyroscope-driven rotation feels steady without noticeable lag.
